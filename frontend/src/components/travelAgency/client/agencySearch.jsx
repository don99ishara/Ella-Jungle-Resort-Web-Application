...
function AgentSearch({ handleSearchInputChange, handleSortChange, sortOrder }) {
  ...
  return (
    ...
    >
      <div
        className='relative flex justify-center mx-auto bg-[#bbf7d0] border rounded-xl'
      ...
      >
        ...
        <label
          ...
          className='pointer-events-none  absolute left-3 top-0 mb-0  origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-green-500 '
        >
          Search
        </label>
      </div>
      ...
      <div className='flex bg-[#86efac] font-bold flex-col justify-center mt-4 mx-auto max-w-full whitespace-nowrap  rounded-xl text-black text-opacity-60 w-[200px]'>
        <div
          className={`flex gap-5 justify-between px-7 py-1.5  bg-opacity-30 border-b cursor-pointer ${
            sortOrder === "name" && "text-[#16a34a]"
          }`}
